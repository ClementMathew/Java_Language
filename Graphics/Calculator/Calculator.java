...
/* Program that works as a Simple Calculator. Arrange Buttons for digits and the + - * % operations properly.
...
public class Calculator 
{
    Calculator ()
    {
        JFrame jrm = new JFrame ("Simple Calculator");
        jrm . setSize ( 500 , 500 );
        jrm.setLocationRelativeTo(null);
